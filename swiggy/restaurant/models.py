...
class RestaurantRegistrationModel(models.Model):
    ...
    restaurant_password = models.CharField(max_length=16)
    ...
    restaurant_status = models.CharField(max_length=20 ,default="Pending")
    #restaurant_otp = models.IntegerField(null=True)
